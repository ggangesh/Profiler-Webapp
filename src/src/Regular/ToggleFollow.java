...
public class ToggleFollow extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        else
        {
            ...
            String status = request.getParameter("follow_btn");
            if(status.equalsIgnoreCase("unfollow_btn")){
            	System.out.println("unfollow pressed");
            	DbHandler.unfollow((int)session.getAttribute("personId"), wallId);
            }
            else{
            	System.out.println("follow pressed");
            	DbHandler.follow((int)session.getAttribute("personId"), wallId);
            }
